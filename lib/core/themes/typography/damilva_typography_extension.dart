...
class DamilvaTypographyExtension
    extends ThemeExtension<DamilvaTypographyExtension> {
  DamilvaTypographyExtension({
  ...
  factory DamilvaTypographyExtension.from(DamilvaTypography typo) {
    return DamilvaTypographyExtension(
      text64w800: typo.text64w800,
      text48w800: typo.text48w800,
      text40w800: typo.text40w800,
      text32w800: typo.text32w800,
      text26w800: typo.text26w800,
      text22w800: typo.text22w800,
      text20w800: typo.text20w800,
      text18w800: typo.text18w800,
      text16w800: typo.text16w800,
      text15w800: typo.text15w800,
      text14w800: typo.text14w800,
      text13w800: typo.text13w800,
      text12w800caps: typo.text12w800caps,
      text11w800caps: typo.text11w800caps,
      ...
      text13w400: typo.text13w400,
      text12w400: typo.text12w400,
      text11w400: typo.text11w400,
    );
  }

  @override
  DamilvaTypographyExtension copyWith({
  ...
  @override
  DamilvaTypographyExtension lerp(
    ThemeExtension<DamilvaTypographyExtension>? other,
    double t,
  ) {
    if (other is! DamilvaTypographyExtension) return this;
