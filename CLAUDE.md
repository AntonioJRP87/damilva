...
**Capa data**
- Data source (contrato): `<feature>_data_source.dart`
- Data source (implementación): `<feature>_remote_data_source.dart` / `<feature>_local_data_source.dart` según origen
- Modelos/DTOs: `<entity>_remote_entity.dart`
- Repositorio (implementación): `<feature>_repository_impl.dart`

**Capa domain**
- Entidades: nombre simple, ej. `car.dart`, `order.dart`, `photo.dart`, `user.dart`
- Repositorio (contrato): `<feature>_repository.dart` (abstract class)
- Casos de uso: `<accion>_use_case.dart`, ej. `login_use_case.dart`, `register_use_case.dart`, `delete_account_use_case.dart`
